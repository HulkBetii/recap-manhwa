...
async def main():
    ...
    print("=" * 80)
    print("  START WORKFLOW: Surviving the Apocalypse - Episodes 1-2 (English)")
    print(f"  URL: {target_url}")
    print("  Market: US Apocalypse (us_apocalypse)")
    ...
    task_id = f"surviving-the-apocalypse-ep1-2-en-{int(time.time())}"
    task = WorkflowTask(
    ...
    ctx._sync_task_db()
    print("\n================================================================================")
    print("  [SUCCESS] 100% RECAP COMPLETE: SURVIVING THE APOCALYPSE EPISODES 1-2 (ENGLISH)!")

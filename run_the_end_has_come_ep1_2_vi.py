...
async def main():
    target_url = "https://www.webtoons.com/en/thriller/the-end-has-come/list?title_no=8421"
    print("=" * 75)
    print("  START WORKFLOW: The End Has Come - Tập 1 & 2 (Tiếng Việt)")
    print("  URL: https://www.webtoons.com/en/thriller/the-end-has-come/list?title_no=8421")
    ...
    task_id = f"the-end-has-come-ep1-2-vi-{int(time.time())}"
    task = WorkflowTask(
        comic_title="The End Has Come",

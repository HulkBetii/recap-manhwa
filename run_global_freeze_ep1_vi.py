...
async def main():
    ...
    print("=" * 75)
    print("  START WORKFLOW: Global Freeze: I Created An Apocalypse Shelter - Tập 1 (Tiếng Việt)")
    print("  URL: https://mgread.io/manga/global-freeze-i-created-an-apocalypse-shelter/")
    ...
    task_id = f"global-freeze-ep1-vi-{int(time.time())}"
    task = WorkflowTask(
